	...
	return (
		<div className="px-8 py-10">
			<div className="mb-8 space-y-2 md:space-x-2">
				...
				<button className="w-full rounded-full border-2 border-gray-800 bg-gray-800 px-6 py-1 text-lg font-semibold text-white md:w-[unset]">General rmation</button>
			</div>
